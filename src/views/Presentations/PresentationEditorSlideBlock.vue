...
<!-- 1. Обложка -->
                  ...
                  >
                    <div class="booklet-info__wrap" :data-block-layout="pe.getBlockLayout(slide)">
                      ...
                      <div class="booklet-info__grid image-grid-bound" :data-image-grid="pe.getImageGrid(slide)">
                        <div
                  ...
                  >
                    <div class="booklet-stroen__wrap" :data-block-layout="pe.getBlockLayout(slide)">
                      ...
                      <div class="booklet-stroen__grid image-grid-bound" :data-image-grid="pe.getImageGrid(slide)">
                        <div
