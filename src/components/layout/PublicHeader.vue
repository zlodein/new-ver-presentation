  ...
  >
    <div class="flex w-full flex-col items-center justify-between grow mx-auto max-w-(--breakpoint-2xl) md:px-6 lg:flex-row">
      ...
      >
        <button
          type="button"
          class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-100 dark:border-gray-800 dark:text-gray-400 dark:hover:bg-gray-800 lg:h-11 lg:w-11"
          :class="[
            isMobileOpen
        ...
        <div class="hidden flex-1 min-w-0 lg:block lg:max-w-full">
          <SearchBar />
        </div>
