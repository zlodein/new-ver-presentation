<template>
  <ComponentCard title="Modal Based Alert">
    ...
    <!-- Success -->
    <Modal v-if="isSuccessModalOpen" :fullScreenBackdrop="true" @close="closeSuccessModal">
      <template #body>
        <div
    ...
    <!-- Info -->
    <Modal v-if="isInfoModalOpen" :fullScreenBackdrop="true" @close="closeInfoModal">
      <template #body>
        <div
          class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10"
        >
    ...
    <!-- Warning -->
    <Modal v-if="isWarningModalOpen" :fullScreenBackdrop="true" @close="closeWarningModal">
      <template #body>
        <div
          class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10"
        >
    ...
    <!-- Danger -->
    <Modal v-if="isDangerModalOpen" :fullScreenBackdrop="true" @close="closeDangerModal">
      <template #body>
        <div
          class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10"
        >
...
const openSuccessModal = () => (isSuccessModalOpen.value = true)
...
const openWarningModal = () => (isWarningModalOpen.value = true)
const closeWarningModal = () => (isWarningModalOpen.value = false)

const isDangerModalOpen = ref(false)

const openDangerModal = () => (isDangerModalOpen.value = true)
const closeDangerModal = () => (isDangerModalOpen.value = false)
</script>
