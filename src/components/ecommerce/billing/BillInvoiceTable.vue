...
<template>
  <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    <!-- Header -->
    <div class="px-6">
      <div class="flex flex-col justify-between gap-5 py-4 sm:flex-row sm:items-center">
        <div>
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Invoices</h3>
          <p class="text-sm text-gray-500 dark:text-gray-400">Access all your previous invoices.</p>
        </div>
        <div>
          <button
            type="button"
    ...
    <!-- Table -->
    <div class="custom-scrollbar overflow-x-auto px-6">
      <table class="min-w-full">
        <thead>
          <tr class="border-y border-gray-200 dark:border-gray-800">
            <th
              class="px-6 py-3 text-left text-sm font-normal text-gray-500 first:pl-0 dark:text-gray-400"
            >
              Name
            </th>
            <th class="px-6 py-3 text-left text-sm font-normal text-gray-500 dark:text-gray-400">
              Date
            </th>
            <th class="px-6 py-3 text-left text-sm font-normal text-gray-500 dark:text-gray-400">
              Price
            ...
            <th class="px-6 py-3 text-right text-sm font-normal text-gray-500 dark:text-gray-400">
              Action
            </th>
          </tr>
        </thead>
        <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
          <tr v-for="invoice in paginatedInvoices" :key="invoice.id">
            <td class="px-6 py-3 text-left whitespace-nowrap first:pl-0">
            ...
            <td
              class="px-6 py-3 text-sm font-normal whitespace-nowrap text-gray-700 dark:text-gray-400"
            >
              {{ invoice.date }}
            </td>
            <td
    ...
    <!-- Pagination -->
    <div class="rounded-b-xl border-t border-gray-200 px-6 py-4 dark:border-gray-800">
      <div class="flex justify-center">
        <div class="block pb-4 text-sm text-gray-700 sm:hidden dark:text-gray-400">
          Showing {{ startItem }} to {{ endItem }} of {{ totalInvoices }} invoices
        </div>
      </div>

      <div
        class="flex items-center justify-between gap-8 bg-gray-50 dark:bg-white/[0.03] dark:sm:bg-transparent p-4 sm:p-0 sm:bg-transparent rounded-lg"
      >
        <button
          @click="previousPage()"
          ...
          "
          class="shadow-theme-xs flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-700 sm:px-3.5 sm:py-2.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400"
        >
          <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M2.58203 9.99868C2.58174 10.1909 2.6549 10.3833 2.80152 10.53L7.79818 15.5301C8.09097 15.8231 8.56584 15.8233 8.85883 15.5305C9.15183 15.2377 9.152 14.7629 8.85921 14.1699L5.13911 10.7472L16.6665 10.7472C17.0807 10.7472 17.4165 10.4114 17.4165 9.99715C17.4165 9.58294 17.0807 9.24715 16.6665 9.24715L5.14456 9.24715L8.85919 5.53016C9.15199 5.23717 9.15184 4.7623 8.85885 4.4695C8.56587 4.1767 8.09099 4.17685 7.79819 4.46984L2.84069 9.43049C2.68224 9.568 2.58203 9.77087 2.58203 9.99715C2.58203 9.99766 2.58203 9.99817 2.58203 9.99868Z"
              fill=""
            />
          </svg>
