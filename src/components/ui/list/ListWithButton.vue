<template>
  <div
    class="w-full overflow-hidden rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] sm:w-[228px]"
  >
    <ul class="flex flex-col">
      <li class="border-b border-gray-200 last:border-b-0 dark:border-gray-800">
        <button
          class="flex w-full items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-500 hover:bg-brand-50 hover:text-brand-500 dark:text-gray-400 dark:hover:bg-brand-500/[0.12] dark:hover:text-brand-400"
        >
          <span>
            <svg
              class="fill-current"
      ...
      <li class="border-b border-gray-200 last:border-b-0 dark:border-gray-800">
        <button
          disabled
          class="flex w-full items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-500 disabled:opacity-50 dark:text-gray-400"
        >
          <span>
            <svg
              class="fill-current"
