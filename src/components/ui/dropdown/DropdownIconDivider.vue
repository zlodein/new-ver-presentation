          ...
          <template v-for="(item, index) in menuItems" :key="index">
            ...
            <li v-else>
              <a
                ...
                class="flex rounded-lg gap-3 items-center px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-white/5"
              >
...
<script setup>
import { FolderIcon, SettingsIcon, SupportIcon, TrashIconLg, UserCircleIcon } from '@/icons'
...
const menuItems = [
  { text: 'Edit Profile', icon: UserCircleIcon, href: '#' },
  { text: 'Settings', icon: SettingsIcon, href: '#' },
  { type: 'separator' },
  { text: 'Edit Profile', icon: UserCircleIcon, href: '#' },
  { text: 'Files', href: '#', icon: FolderIcon },
  { text: 'Support', href: '#', icon: SupportIcon },
  { type: 'separator' },
  { text: 'Delete', href: '#', icon: TrashIconLg },
]
