<template>
  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
    ...
    <div>
      ...
      >
        <div class="mb-5 overflow-hidden rounded-lg">
          <img src="/images/cards/card-01.png" alt="card" class="overflow-hidden rounded-lg" />
        </div>
        ...
        <div>
          ...
          <a
            href="#"
            class="inline-flex items-center gap-2 px-4 py-3 mt-4 text-sm font-medium text-white rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600"
          >
            Read more
          </a>
        </div>
    ...
    <div>
      ...
      >
        <div class="mb-5 overflow-hidden rounded-lg">
          <img src="/images/cards/card-02.png" alt="card" class="overflow-hidden rounded-lg" />
        </div>
    ...
    <div>
      ...
      >
        ...
        <div>
          ...
          <a
            href="#"
            class="inline-flex items-center gap-1 mt-4 text-sm text-brand-500 hover:text-brand-600"
          >
            <svg
              class="fill-current"
              width="16"
