        ...
        <thead>
          <tr>
            ...
            <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
              ...
              >
                <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">Position</p>
                <span class="flex flex-col gap-0.5">
                  <svg
                    class="fill-gray-300 dark:fill-gray-700"
                    width="8"
            ...
            <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
              <div
                ...
                @click="sortBy('salary')"
              >
                <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">Salary</p>
                <span class="flex flex-col gap-0.5">
                  <svg
                    class="fill-gray-300 dark:fill-gray-700"
                    width="8"
            ...
            <th class="px-4 py-3 text-left border border-gray-100 dark:border-gray-800">
              <div
                ...
                @click="sortBy('office')"
              >
                <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">Office</p>
                <span class="flex flex-col gap-0.5">
                  <svg
                    class="fill-gray-300 dark:fill-gray-700"
                    width="8"
              ...
              <span
                :class="{
                  'bg-success-50 dark:bg-success-500/15 text-success-700 dark:text-success-500':
                    person.status === 'Hired',
                  'bg-warning-50 dark:bg-warning-500/15 text-warning-700 dark:text-orange-400':
